...
La connexió enp2s0 serà Manual. Tindrà una xarxa interna 192.168.10.0/24.
La IP manual del servidor DMZ és 192.168.10.2/24.
...
ECHO "la connexió \"internet\" és enp2s0 amb Address=192.168.10.2 Gateway=192.168.10.1 i DNS=1.1.1.1?"
