...
install_zammad(){
    ...
    echo "Install Zammad, un altre mica ..."
    incus exec mycontainer -- bash -c  "curl -fsSL \"https://go.packager.io/srv/deb/zammad/zammad/gpg-key.gpg\" -o /usr/share/keyrings/zammad.gpg && sudo chmod 644 /usr/share/keyrings/zammad.gpg"
