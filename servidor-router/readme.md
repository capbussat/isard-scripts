...
### Hi ha tres xarxes d'isard: 
enp1s0 default   
enp2s02 wireguard-vpn   
enp3s0 Personal 1  
cd /etc/systemd/network/  
ls  
### Crea un dhcp en la xarxa 10.10.10.0/24 que comença per 10.10.10.101
Hi ha 4 fitxers, un per cada xarxa: 10.network 20.network, 30.network i 40.network.  
...
echo "Posa net.ipv4.ip_forward=1 en el fitxer."
...
### Canvia aquests paràmetres per tenir accés al DNS 
DNS=1.1.1.1  
